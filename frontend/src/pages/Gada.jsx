...
const Gada = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState('gada');
  ...
  useEffect(() => {
    ...
    if (categoryParam && categories.includes(categoryParam)) {
      ...
      // Default to gada if no category in URL
      setSelectedCategory('gada');
    }
  }, []);
  ...
  // Handle category click - navigate to specific route
  const handleCategoryClick = (category) => {
    if (category === 'all') {
      navigate('/products');
    } else if (category === 'gada') {
      navigate('/products/gada');
    } else if (category === 'mudgar') {
      navigate('/products/mudgar');
    } else {
